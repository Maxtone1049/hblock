...
<title>For Rent &amp; Lease | Hutblock</title>
    ...
    <div class="container">
        <div class="rowSearch">
            <div class="col-12 searchContent">
                <form  method="get" id="quickSearch" _lpchecked="1" class="form-group" style="display: inline;">
                    <div id="bookForm" class="row">
                        <div class="col-md-4 pl-1 pr-1">
                            <input class="form-control searchListings" type="text" name="trt" placeholder="e.g. Ikoyi, Lagos or Property Reference" autocomplete="off">
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="main-content col-md-8">
                    ...
                    <div class="row">
                        <h1 id="resultTitle">Results for Property for Rent in Nigeria</h1>
                    </div>
                    ...
                    <div class="row cardly">
                            <div class="col-md-12 mb-3 pr-0" id="resTitle">
                                <div class="row resTitle">
                                    <span class="col-md-7">Results | For Rent</span>
...
<input class="try" type='Submit' value="For Rent" id='keyword' maxlength='40' autofocus="" >
<input type='text' name='search[keyword]' placeholder="Search property for-rent" value="For Rent" id='keyword' maxlength='40' autofocus="" hidden>
<input type='text' name='search[next]' placeholder="Search property for-rent" value="Shortlet" id='next' maxlength='40' autofocus="" hidden>
  <?php
    if(!empty($result)) { 
   ...
   <div class="recentLs  col-md-12 col-sm-12">
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <a class="mediaLink" href="details/3-bedroom-flat-apartment-shortlet-at-victoria-island-lagos-RS38549" target="_blank">
<img data-fancybox="RS38549" title="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos" src="https://hutbay.blob.core.windows.net/listing-preview/535b482cc2c646e9bd0843554ee23342.jpeg" alt="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos">
                        <div class="posBottom mediaCount">
                            <span><i class="fa fa-camera"></i> 8 photos</span>
                        </div>
                </a>
            </div>
                <span>
<span data-fancybox="RS38549" title="Luxury 3 Bedroom Apartment" data-caption="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos, Victoria Island, Lagos <br /><br /> <a href='details/RS38549' target='_blank'>View Details</a>" data-src="https://hutbay.blob.core.windows.net/listing-big/3f05bec692344b6fa8746d484c50fbe8.jpeg">
</span>
<span data-fancybox="RS38549" title="Luxury 3 Bedroom Apartment" data-caption="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos, Victoria Island, Lagos <br /><br /> <a href='details/RS38549' target='_blank'>View Details</a>" data-src="https://hutbay.blob.core.windows.net/listing-big/d637d066aeda4c0591fa17b6bf8a05de.jpeg">
</span>
<span data-fancybox="RS38549" title="Luxury 3 Bedroom Apartment" data-caption="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos, Victoria Island, Lagos <br /><br /> <a href='details/RS38549' target='_blank'>View Details</a>" data-src="https://hutbay.blob.core.windows.net/listing-big/1b38f2164e0a4ebeab06b0e9457b165c.jpeg">
</span>
<span data-fancybox="RS38549" title="Luxury 3 Bedroom Apartment" data-caption="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos, Victoria Island, Lagos <br /><br /> <a href='details/RS38549' target='_blank'>View Details</a>" data-src="https://hutbay.blob.core.windows.net/listing-big/1e86f3ed5d434f78959af625f889a26a.jpeg">
</span>
<span data-fancybox="RS38549" title="Luxury 3 Bedroom Apartment" data-caption="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos, Victoria Island, Lagos <br /><br /> <a href='details/RS38549' target='_blank'>View Details</a>" data-src="https://hutbay.blob.core.windows.net/listing-big/0d15fa73f46e4029a5c2aac0bed8fce8.jpeg">
</span>
<span data-fancybox="RS38549" title="Luxury 3 Bedroom Apartment" data-caption="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos, Victoria Island, Lagos <br /><br /> <a href='details/RS38549' target='_blank'>View Details</a>" data-src="https://hutbay.blob.core.windows.net/listing-big/bd5831d9bb5b4ac8b05af72f6b725997.jpeg">
</span>
<span data-fancybox="RS38549" title="Luxury 3 Bedroom Apartment" data-caption="<?php echo $row['bedroomsnum']?> Bedroom Flat Apartment Shortlet at Victoria Island, Lagos, Victoria Island, Lagos <br /><br /> <a href='details/RS38549' target='_blank'>View Details</a>" data-src="https://hutbay.blob.core.windows.net/listing-big/4709f9cdec594a9c8cd125866361af93.jpeg">
</span>
                </span>
                    ...
                    <div class="card pt-0 pb-0">
                        <div class="card-group-item">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <a href="cdn-cgi/l/email-protection#61121411110e1315210914150300184f020e0c" class="app-button"><i class="far fa-bell"></i> Get FREE Quotes</a>
                                </div>
                            </div>
                        </div>
                    </div>
